<script lang="ts">
    ...
    export let joinRoom: (name: string, roomId: string) => void;
    let name: string;
    let roomId: string;
     // Trigger the startGame function when the socket event is received
    function sendAnswer(name: string, roomId: string) {
